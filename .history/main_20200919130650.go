...
const (
	...
	helmStableURL       = "https://api.github.com/repos/helm/helm/releases/31536999" //we should see how we can get this automatically like the above URL.
...
func getHelm() {
	resp, err := http.Get(helmStableURL)
	...
	// if strings.TrimRight(text, "\n") == "yes" || strings.TrimRight(text, "\n") == "y" {
	// 	fmt.Println("Downloading Helm version: " + " " + result + "to" + " " + installLocationHelm)
	// 	// There is a bug somewhere appending a new line to the result, causing a nil pointer reference
	// 	downloadFile(installLocationHelm, strings.TrimRight(result, "\n"), "helm")
